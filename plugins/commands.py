...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton("⚡ UᎮDΛTΞS ⚡", url="https://t.me/chigosTvhub")
            ],[
            InlineKeyboardButton("🔞 ΛDULϮ BԾϮ 🔞", url="https://t.me/Chigostv_Erotic_DB")
        ]]
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton("🧩 TUϮԾᏒIΛL", url="https://t.me/ChigosTv_Tutorial_DB"),
            InlineKeyboardButton("🍿 UᎮDΛTΞS 🍿", url="https://t.me/chigosTvhub")
            ],[
